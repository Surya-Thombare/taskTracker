...
const updateTask = async (req, res) => {
  try {
    ...
    if (error.message.includes('Cannot update a') ||
      error.message === 'To mark task as completed, use the complete endpoint' ||
      error.message === 'Cannot cancel a task with active timers') {
      return errorResponse(
        res,
